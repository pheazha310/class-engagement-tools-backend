...
const mainMenuItems: SidebarItem[] = [
  ...
  { label: "User Management", icon: "users", route: "/admin/dashboard/users" },
  { label: "Role Management", icon: "shield", route: "/admin/dashboard/roles" },
  { label: "School Name", icon: "building", route: "/admin/dashboard/school-names" },
];
...
const iconMap: Record<string, string> = {
  ...
  building:
    '<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21h18"/><path d="M9 3h6v18H9z"/><path d="M16 9h4v12H16z"/><path d="M4 9h4v12H4z"/></svg>',
  book:
    '<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/></svg>',
  activity:
    '<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>',
  shield:
  ...
  chart:
    '<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>',
  settings:
...
<template>
  ...
  >
    <!-- Logo area -->
    <div
      class="flex items-center h-16 px-4 border-b border-gray-100 dark:border-gray-700 shrink-0"
      :class="collapsed && !mobileOpen ? 'justify-center' : 'gap-3'"
    >
      <div v-if="!collapsed || mobileOpen" class="flex items-center gap-3">
        <div
          class="flex items-center justify-center w-8 h-8 font-bold text-white rounded-lg bg-blue-600 text-sm"
        >
          CE
        </div>
    ...
    <nav class="flex-1 px-3 py-4 overflow-y-auto scrollbar-thin">
      ...
      >
        ...
        />
        <span v-if="!collapsed || mobileOpen" class="text-sm font-medium truncate">{{
          item.label
        }}</span>
        <span
      ...
      <div
        v-if="!collapsed || mobileOpen"
        class="my-4 border-t border-gray-100 dark:border-gray-700"
      />
